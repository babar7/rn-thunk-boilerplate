  ...
  deletePostHandler = () => {
    ...
    request(
      ...
      () => {
        ...
        generalSaveAction(EXPLORE_POST.SUCCESS, updatedPost);
          ...
          >
            ...
            <View style={styles.halfScreen}>
              ...
              <FlatListHandler
                ...
                fetchRequest={(abc, cde) =>
                  global.log("fetchRequestCall :", abc, cde)
                }
                // isFetching={"abc"}
              />
            </View>
...
const mapStateToProps = ({ explorePosts, user, watchList, generalPosts }) => ({
  posts: explorePosts["data"],
  watchList: watchList["data"],
  generalPosts: generalPosts["data"],
  user: user["data"].user,
});

export default connect(mapStateToProps, actions)(ExplorePost);
